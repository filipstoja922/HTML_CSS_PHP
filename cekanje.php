	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				<h2 style="text-align:center; color:#FF0000; font-family: 'Courier New', Courier, monospace">Hvala vam sto ste poslali vas zahtev. 
				Odgovoricemo vam cim verifikujemo vase placanje<br>
				Mozete se ulogovati da vidite vas status time sto cete uneti vas email i ID broj.</h2>
			</ul>
