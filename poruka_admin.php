...
<body>
	...
	<section class="listings">
		<div class="wrapper">
		<h2 style="text-decoration:underline">Posalji poruku adminu</h2>
			<ul class="properties_list">
			<form method="post">
				<table>
					<tr>
						<td style="color: #003300; font-weight: bold; font-size: 24px">Unesi poruku ovde:</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>
							<textarea name="message" placeholder="unesi poruku" class="txt"></textarea>
						</td>
					</tr>
					<tr>
						<td><input type="submit" name="send" value="Posalji poruku"></td>
					</tr>
				</table>
			</form>
				<?php
					if(isset($_POST['send'])){
						...
						$qry = "INSERT INTO poruke (poruka,client_id,vreme,status)
							VALUES('$message','$_SESSION[email]',NOW(),'Unread')";
							$result = $conn->query($qry);
							if($result == TRUE){
								echo "<script type = \"text/javascript\">
											alert(\"Poruka uspesno poslata\");
											window.location = (\"ulogovan.php\")
											</script>";
							} else{
								echo "<script type = \"text/javascript\">
											alert(\"Poruka nije poslata. Pokusajte ponovo\");
											window.location = (\"poruka_admin.php\")
											</script>";
							}
					}
				?>
